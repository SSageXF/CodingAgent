...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model", help="model name; or configure .env/EVIDENCECODER_MODEL")
    parser.add_argument("--base-url", help="OpenAI-compatible API base URL")
    parser.add_argument("--api-key", help="API key; .env or environment variables are preferred")

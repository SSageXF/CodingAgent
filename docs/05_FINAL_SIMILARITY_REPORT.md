...
初次核查：2026-08-28；交互式、`.env` 与 0.3.0 扩展版本复核：2026-08-30

当前自研源码提交：`3e1cc55a00ab62e8cb37799201b60dde210dfa06`
...
本地忽略缓存。最新报告为 `.audit-cache/similarity-report-v030.json`，SHA-256 为
